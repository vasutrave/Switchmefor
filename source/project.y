...
labeled_stat				: id ':' stat
							...
							| DEFAULT ':'{switch_default();} stat{insert(1,$1,"Keyword");}
							;
...
selection_stat				: SWITCH '(' exp ')' {  strcpy(switch_exp,$3);
								is_for_or_switch = 2;switch_start();} stat {insert(1,$1,"Keyword");switch_end();}
							;
...
jump_stat					: CONTINUE ';'{insert(1,$1,"Keyword");}
							| BREAK ';'{	break_found=1;insert(1,$1,"Keyword");
